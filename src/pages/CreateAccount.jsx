...
//                     type="text"
//                     placeholder="GST No. "
//                     className="mt-8 outline-none py-3 px-2 border border-[#0077B3]/[.5] rounded-md"
//                   />
...
import chembizzlogo from '../images/chembizzlogo.png'
...
<div className="relative w-full min-h-[100vh] flex items-center justify-center overflow-hidden">
    ...
    <div className="max-w-[1600px] w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        {/* LEFT: logo + text */}
    <div className="order-2 lg:order-1 lg:pl-4 xl:pl-8">  {/* small push-in for balance */}
          <img
            src={chembizzlogo}   // put file in /public/assets/
            alt="ChemBiZZ"
      ...
      <div className="order-1 lg:order-2 flex lg:justify-start lg:pl-6 xl:pl-0"> 
          <div
            className="
              w-full max-w-[638px]
...
{formData.confirmPassword && !confirmPasswordError && (
  <p className="text-green-500 text-sm mt-1">Passwords match ✓</p>
              ...
              <div className="flex gap-6 items-start">
                ...
                <p className="text-darkBlue font-thin">
                  By clicking on this, you agree to our <span className="text-[#00AEEF]"  onClick={() => navigate("/terms-and-conditions")}>Terms & Conditions</span>, <span className="text-[#00AEEF]">Terms of use</span>, and <span className="text-[#00AEEF]"  onClick={() => navigate("/privacy-policies")}>Privacy Policy</span>
                </p>
              </div>
