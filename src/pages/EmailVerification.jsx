  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-gray-50 flex items-center">
      ...
      <div className="absolute inset-0 -z-0">
        <img
          src={backgroundimg}            /* make sure this file is in /public/assets */
          alt="background"
      ...
      <section className="relative w-full px-4 md:px-10 xl:px-16 py-10 md:py-16">
        <div className="mx-auto max-w-[1500px] grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left font-[Poppins] lg:pr-6 xl:pr-0">
            <img
              src={chembizzlogo}   /* place in /public/assets */
              alt="ChemBizz Logo"
